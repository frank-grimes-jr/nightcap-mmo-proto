...
- How do weapon skills and armor proficiency interact across three classes? (Resources resolved in D-017: universal HP/MP/Energy pools that abilities draw from natively, no per-slot re-costing; base attributes fold into D-015 functional buckets.)
